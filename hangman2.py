...
def main(argv):
    ...
    wordList = args.wordlist if args.wordlist != [None] else gs.WORDLIST # generated by PowerShell from larger OpenTaal source file
    answer = choose_line(wordList, args.length)
